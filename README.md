...
An alternative DAG version is also included in this repository, this approach is more in line with what the originators of the NGAC Policy Machine had in mind but was not part of our final solution due to visual preference and tedious layout management due to access right edges in the graph. 
